...
class GoodsAddView(View):
    ...
    def post(self, request):
        ...
        good = Goods.objects.create(name=name, category_id=parent_id, market_price=market_price, price=price,
                                    goods_desc=goods_desc, main_img=main_img, user_id=request.user.id)
        good.save()
